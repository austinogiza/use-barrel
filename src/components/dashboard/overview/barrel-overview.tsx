...
const BarrelOverview: FC<BarrelOverviewProps> = (props) => {
  ...
  return (
    <div className="max-w-[650px] duration-300 transition-all hover:border-neutral-200 cursor-pointer relative min-h-[96px] bg-white shadow-sm border border-neutral-50 rounded-lg w-full flex flex-col items-start justify-center px-4 z-[2]">
